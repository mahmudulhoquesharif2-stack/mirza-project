...
export default function Home() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Alphanumeric TxnID format validation (e.g. 10 characters)
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Online Ilmus Sarf course with live support and structured Arabic grammar lessons."
        />
      </Head>
      <div className="bg-[#090d13] text-white min-h-screen font-sans">
        ...
        <section className="container hero max-w-6xl mx-auto px-6 py-12 md:py-24" id="home">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="hero-copy-area text-center md:text-left">
              ...
              <div className="hero-rest reveal mt-6">
                <p className="hero-copy text-gray-400 text-base md:text-lg leading-relaxed">
                ...
                <div className="hero-actions flex flex-wrap gap-4 mt-8">
                  <a className="btn btn-primary bg-[#00e6a6] hover:bg-[#00ffd0] text-black font-bold px-6 py-3 rounded-full transition" href="#payment">
                    এখনই ভর্তি হন
                  </a>
                  {session ? (
                    <Link className="btn btn-secondary bg-white/5 border border-white/10 hover:bg-white/10 text-white font-bold px-6 py-3 rounded-full transition" href="/dashboard">
                      ড্যাশবোর্ড (Dashboard)
                    </Link>
                  ) : (
                    <Link className="btn btn-secondary bg-white/5 border border-white/10 hover:bg-white/10 text-white font-bold px-6 py-3 rounded-full transition" href="/auth/signin">
                      লগইন করুন (Login)
                    </Link>
                  )}
                </div>
            ...
            <div className="hero-visual reveal flex justify-center" id="instructor">
              <div className="spotlight-ring relative">
                <img
                  className="portrait w-64 h-64 md:w-80 md:h-80 rounded-full border-4 border-[#00e6a6]/30 shadow-2xl object-cover"
                  src="/instructor.jpg"
                  alt="উস্তায ফায়েজ বিন মাহমুদ"
                />
                <div className="portrait-badge absolute bottom-0 left-0 right-0 bg-black/80 backdrop-blur-md border border-white/10 rounded-2xl p-4 text-center">
                  <h3 className="font-bold text-gray-200">
                    উস্তায ফায়েজ বিন মাহমুদ
                  </h3>
                  <span className="block text-xs text-gray-400 mt-1">লেকচারার, IIUC</span>
        ...
        {/* Payment Section */}
        <section className="container payment-console max-w-6xl mx-auto px-6 py-12" id="payment">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <article className="contact-panel bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-3xl flex flex-col justify-between shadow-lg">
              <div>
                ...
                <div className="space-y-4">
                  <a className="contact-action primary flex justify-between items-center bg-[#00e6a6]/10 border border-[#00e6a6]/30 hover:border-[#00e6a6] p-4 rounded-2xl transition" href="https://wa.me/8801310787139">
                  ...
                  <a className="contact-action flex justify-between items-center bg-white/5 border border-white/10 hover:border-white/20 p-4 rounded-2xl transition" href="https://www.facebook.com/AtTaheelAcademy">
            ...
            <article className="secure-panel bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-lg relative">
              ...
              <div className="space-y-3.5 mb-6">
                <div className="payment-field flex justify-between items-center bg-black/30 border border-white/5 p-4 rounded-2xl">
                  ...
                  <div className="field-actions flex gap-2">
                    <button 
                      type="button" 
                      onClick={() => handleCopy('01837772215')}
                      className="px-3.5 py-1.5 bg-white/5 border border-white/10 hover:bg-white/10 rounded-xl text-xs font-bold transition"
                    >
                ...
                <div className="payment-field flex justify-between items-center bg-black/30 border border-white/5 p-4 rounded-2xl">
                  ...
                  <div className="field-actions flex gap-2">
                    <button 
                      type="button" 
                      onClick={() => handleCopy('01310787139')}
                      className="px-3.5 py-1.5 bg-white/5 border border-white/10 hover:bg-white/10 rounded-xl text-xs font-bold transition"
                    >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      className="w-full h-10 px-3 bg-[#0d131e] border border-white/10 rounded-xl text-sm focus:outline-none focus:border-[#00e6a6]"
                      value={method}
                  ...
                  <div>
                    ...
                    {session ? (
                      <input
                        type="text"
                        disabled
                        className="w-full h-10 px-3 bg-white/5 border border-white/10 rounded-xl text-sm text-gray-400 focus:outline-none"
                        value={userBackground === 'MADRASAH' ? '৩,৯০০ BDT' : '৫,৩০০ BDT'}
                      />
                    ) : (
                      <select
                        className="w-full h-10 px-3 bg-[#0d131e] border border-white/10 rounded-xl text-sm focus:outline-none focus:border-[#00e6a6]"
                ...
                <div>
                  ...
                  <input
                    type="tel"
                    required
                    className="w-full h-10 px-4 bg-white/5 border border-white/10 rounded-xl text-sm placeholder-gray-600 focus:outline-none focus:border-[#00e6a6] focus:ring-1 focus:ring-[#00e6a6]"
                ...
                <button
                  type="submit"
                  className="w-full h-11 bg-gradient-to-r from-[#00e6a6] to-[#00b380] hover:from-[#00ffd0] hover:to-[#00e6a6] text-black font-bold rounded-xl transition shadow-[0_0_24px_rgba(0,230,166,0.15)] text-sm"
                >
                  পেমেন্ট সাবমিট করুন
                </button>
              </form>
